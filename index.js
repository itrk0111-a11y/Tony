...
const CHANNEL_TASKS = 81671599;
const CHANNEL_ALLIANCE = 81671599;
const TARGET_PLAYER_NAME = 'Toney';
...
client.login(process.env.U_MAIL, process.env.U_PASS);esolve => setTimeout(resolve, 306000));
